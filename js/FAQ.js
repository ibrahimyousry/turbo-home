...
$(function () {
    ...
    $('.the-ques').on('click', function () {
        
        if($(this).hasClass('active')){
            $('.the-ques').removeClass('active');
            $(this).removeClass('active');
            $('.the-answer').slideUp();
            $(this).children('.updown-icon').toggleClass('fa-chevron-down');
            $(this).children('.updown-icon').toggleClass('fa-chevron-up');
        } else {
            $('.the-ques').removeClass('active');
            $(this).addClass('active');
            $('.the-answer').slideUp();
            $(this).siblings('.the-answer').slideDown();
            $(this).children('.updown-icon').toggleClass('fa-chevron-down');
            $(this).children('.updown-icon').toggleClass('fa-chevron-up');
        }
